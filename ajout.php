                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      ...
                      <div class="form-group row">
                        <label for="poids" class="col-sm-3 col-form-label">Poids total</label>
                        <div class="col-sm-9">
                          <input type="text" class="poids" id="poids" placeholder="Poids total">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label for="prix" class="col-sm-3 col-form-label">prix total payé</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="prix" placeholder="prix total payé">
                        </div>
                      </div>
